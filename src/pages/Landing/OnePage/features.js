                ...
                <Container>
                    <Row className="align-items-center gy-4">
                        ...
                        <Col className="col-sm-auto">
                            <div>
                                <Link to="/1.envato.market/Hiry-admin" target="_blank" className="btn bg-gradient btn-danger"><i className="ri-shopping-cart-2-line align-middle me-1"></i> Buy Now</Link>
                            </div>
                        </Col>
                    </Row>
                </Container>
