...
const Settings = () => {
  const SingleOptions = [
    { value: "Choices 1", label: "Texas" },
    { value: "Choices 2", label: "California" },
    { value: "Choices 3", label: "Florida" },
    { value: "Choices 4", label: "New Jersey" },
  ];
                    ...
                    <TabPane tabId="2">
                      ...
                      <div className="mt-4 mb-3  pb-2">
                        ...
                        <p className="text-muted">
                          Visa Status Copy, Passport Copy and Driving Licence
                          Copy
                        </p>
                        <div>
                          <Dropzone
