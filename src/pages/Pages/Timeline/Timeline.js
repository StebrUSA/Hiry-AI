...
const Timeline = () => {
    ...
    document.title = "Timeline | Hiry AI |  Job Search, Hiring, Technical Screening unified platform";
                                ...
                                <div className="timeline">
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            ...
                                            <p className="text-muted">Every team project can have a Hiry. Use the Hiry to share information with your team to understand and contribute to your project.</p>
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            <h5>Hiry admin dashboard templates layout upload</h5>
