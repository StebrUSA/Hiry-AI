...
const BasicLogout = () => {
    document.title="Log Out | Hiry AI |  Job Search, Hiring, Technical Screening unified platform";
    return (
        <React.Fragment>
                                        ...
                                        <Card className="mt-4">
                                            <CardBody className="p-4 text-center">
                                                ...
                                                <div className="mt-4 pt-2">
                                                    ...
                                                    <p className="text-muted">Thank you for using <span className="fw-semibold">Hiry</span> admin template</p>
                                                    <div className="mt-4">
