...
const CoverTwosVerify = () => {
    document.title = "Two Step Verification | Hiry AI |  Job Search, Hiring, Technical Screening unified platform";
                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                ...
                                                <div className="mt-5 text-center">
                                                    <p className="mb-0">Didn't receive a code ? <Link to="/password-reset" className="fw-semibold text-primary text-decoration-underline">Resend</Link> </p>
                                                </div>
                                            </div>
                                        </Col>
                                    </Row>
