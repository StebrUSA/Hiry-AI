...
const ConfirmCoverSignup = () => {
    document.title = "Registration Confirmation | Hiry AI |  Job Search, Hiring, Technical Screening unified platform";
                                    ...
                                    <Row className="justify-content-center g-0">
                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                <h5 className="text-primary">Verification Link Has Been Sent To Your Email</h5>
...
export default ConfirmCoverSignup;