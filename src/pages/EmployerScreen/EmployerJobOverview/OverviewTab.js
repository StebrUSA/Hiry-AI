                    ...
                    <Card>
                        <CardBody>
                            <div className="text-muted">
                                ...
                                <p>UI/UX and Web Developer who is passionate about their work, eager to learn and grow, and who is committed to delivering exceptional results. If you are a team player, with a positive attitude and a desire to make a difference, then we want to hear from you!</p>


                                <h6 className="mb-3 fw-semibold text-uppercase">About The Job</h6>
                                <ul className="ps-4 vstack gap-2">
                                    <li>Experience: 5+ years</li>
                                    <li>
                                    Salary: INR 2,50,000 - 2,91,000/ month (based on experience)
                                    </li>
                                    <li>Full-time, Remote</li>
                                </ul>
                                <h6 className="mb-3 fw-semibold text-uppercase">Client is looking for</h6>
                                <ul className="ps-4 vstack gap-2">
                                    <li>Develop new user-facing features</li>
                                    <li>Build reusable code and libraries for future use</li>
                                    <li>Ensure the technical feasibility of UI/UX designs</li>
                                    <li>Optimize applications for maximum speed and scalability</li>
                                    <li>Troubleshoot existing web applications</li>
                                </ul>
                                ...
                                <h6 className="mb-3 fw-semibold text-uppercase">Roles & Responsibilities</h6>
                                <ul className="ps-4 vstack gap-2">
                                    <li>Develop new user-facing features</li>
                                    <li>Build reusable code and libraries for future use</li>
                                    <li>Ensure the technical feasibility of UI/UX designs</li>
                                    ...
                                    <Row>
                                        ...
                                        <Col lg={3} sm={6}>
                                            <div>
                                                ...
                                                <h5 className="fs-15 mb-0">02 June, 2023</h5>
                                            </div>
                                        </Col>
                                        <Col lg={3} sm={6}>
                                            <div>
                                                <p className="mb-2 text-uppercase fw-medium">Due Date :</p>
                                                <h5 className="fs-15 mb-0">29 August, 2023</h5>
                                            </div>
                                        </Col>
                                        <Col lg={3} sm={6}>
                                            <div>
