     ...
     <Row>
       ...
       <Col>
         <Row>
           <Col xxl={3}><Label htmlFor="eventName" className="form-label">
             ...
             <Input onChange={handleEventNameChange}
               ...
               id="eventName"
               placeholder="Enter Heading of Event"
           ...
           <Col xxl={3}><Label htmlFor="firstnameInput" className="form-label">
             Place/Venue
           </Label>
         ...
         <div className='text-end'><Button className='mt-3' color="primary" onClick={() => {
           ...
           <i className="ri-add-fill me-1 align-bottom"></i> Update</Button>
